...
class IncidentConfig:
    ...
    # Service registry — architecture metadata for AI context
    service_registry: dict[str, dict]          # service_name → {description, service_type, ...}
    ...
    def load(cls, config_path: str | None = None) -> "IncidentConfig":
        ...
        return cls(
            ...
            # EventBridge / Lambda
            eventbridge_source=data.get("eventbridge_source", "sre-platform"),
