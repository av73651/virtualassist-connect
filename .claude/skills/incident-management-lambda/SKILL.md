---
name: incident-management-lambda
description: "Lambda incident patterns — function errors, OOM, throttling, timeouts, cold starts, concurrency diagnostics."
---
...
| Classification | Action | Catalog Key | Automation |
|---------------|--------|-------------|-----------|
| `bad-deployment` | `lambda-version-rollback` | `remediation_catalog.bad-deployment` | AUTO |
| `performance-degradation` | `lambda-memory-increase` | `remediation_catalog.performance-degradation` | AUTO |
| `rate-limit` | `increase-concurrency` | `remediation_catalog.rate-limit` | AUTO |
| `concurrency-exhaustion` | `increase-concurrency` | `remediation_catalog.concurrency-exhaustion` | AUTO |
| `memory-exhaustion` | `lambda-memory-increase` | Reuses performance-degradation | AUTO |
| `timeout-exhaustion` | `increase-lambda-timeout` | Proposed | MANUAL |
| `cold-start-storm` | `increase-provisioned-concurrency` | Proposed | MANUAL |
